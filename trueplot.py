...
ds = {'Gold AUD': ['Gold AUD', 'GOLD_AUD', 'dsets/GOLD.csv', 'PRICE_AUD', '%d/%m/%y', 'm', 'plot'],\
			...
			'AUS Interest Rate': ['AUS Interest Rate', 'AU_INTEREST', 'dsets/AU_INTEREST.csv', 'RATE', '%Y-%m-%d', 'r'],\
			...
			#'Solar Flares - X Class': ['Solar Flares - X Class', 'FLARES', 'dsets/X_CLASS_FLARE.csv', '%Y-%m-%d', 'r', 'scatter']}
